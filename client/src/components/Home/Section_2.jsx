...
function Section_2() {
    ...
    return (
        <div>
            <div className="bg-white lg:min-h-[400px] px-5 lg:p-0 max-w-[1200px] items-center mx-auto my-5 grid grid-cols-1 lg:grid-cols-3">
                ...
                <div className="col-span-2 rounded grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 text-white p-5 h-screen md:h-[600px] lg:h-[200px] bg-[#7f1657]">
